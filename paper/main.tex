...
The thesis can be further extended with novel ways of signing or by improving flexibility, which is not completely up to par with compared software.
}
...
While, specifically in the European Union, electronic signatures seem to be used relatively extensively in communication with the government, they do not seem to have been widely adopted in exchange between individuals or smaller organizations, which still seem to prefer handwritten signatures.
...
Also, we explain technical preconditions, focusing on the cryptographic concepts like asymmetric cryptography, timestamping, hashing, and standards that comply with the laws of the European Union.
