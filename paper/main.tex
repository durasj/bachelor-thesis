...
\iffalse % This was not yet stable at the time of publishing
...
To improve on this further, we tried to do a \pojem{code-signing} for each release using a trusted way for each platform.
...
We were not able to finish the process on time for the publishing of this thesis - we feel like this process could be improved in the future for OSS.
